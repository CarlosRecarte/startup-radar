  ...
  return (
    <div className="p-6 max-w-7xl mx-auto flex flex-col items-center justify-center min-h-[60vh] text-center">
      ...
      <p className="text-sm text-zinc-400 mb-1 max-w-sm">
        Hubo un problema al cargar las startups desde Supabase. Comprueba tu conexión
        y que las credenciales en <code className="text-violet-400">.env.local</code> sean correctas.
      </p>
      {error.digest && (
